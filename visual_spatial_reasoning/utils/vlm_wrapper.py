...
class VLMWrapper:
    def __init__(self, model_name, qa_model_name=None):
        ...
        elif model_name in ['Qwen/Qwen3-VL-8B-Instruct']:
    ...
    def format_prompt(self, prompt_type, question, answer_choices, images, 
                      imagined_frames=None, action_consequences=None, 
                      sys_prompt=None, policy_text=None):
        ...
        if prompt_type == 'answer_baseline':
            ...
            return format_spatial_vqa_prompt_answer_scaling_no_cot(question=question, answer_choices=answer_choices, images=images, action_consequences=action_consequences)
        
        elif prompt_type == 'answer_scaling_mmsi':
            return format_spatial_vqa_prompt_answer_scaling_mmsi(question=question, images=images, action_consequences=action_consequences) 
        ...
        elif prompt_type == "action_search":
            return format_action_search(question=question, answer_choices=answer_choices, images=images, imagined_frames=imagined_frames, action_consequences=action_consequences)
        
        elif prompt_type == "policy_plan":
            return format_spatial_vqa_prompt_policy_plan(question=question, answer_choices=answer_choices, images=images)
        
        elif prompt_type == "prompt_scores_policy_plan":
            return format_spatial_vqa_prompt_plan_scores(question=question, answer_choices=answer_choices, images=images, plan=action_consequences)
        
        elif prompt_type == "policy_verification":
            return format_policy_plan_verification(question=question, answer_choices=answer_choices, images=images, policy_text=policy_text) 
